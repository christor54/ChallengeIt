...
public class SelectUserListAdapter extends ArrayAdapter<String> {
    private HashMap<Integer, Boolean> myChecked = new HashMap<Integer, Boolean>();
    private boolean startWithItemsChecked;
    private final ArrayList<String> users;
    private int playerItemLayoutId;

    public SelectUserListAdapter(Context context, int itemLayoutId, ArrayList<String> users, boolean startWithItemsChecked) {
