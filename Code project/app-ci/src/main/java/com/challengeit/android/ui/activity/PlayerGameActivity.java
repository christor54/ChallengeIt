...
public class PlayerGameActivity extends FragmentActivity {
    private Game game;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.game_player, menu);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.activity_game_player, container, false);
            return rootView;
        }
    }
